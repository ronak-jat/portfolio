...
// Updated ScrollReveal for Hero and About based on new structure
sr.reveal(".hero__content");
sr.reveal(".hero__img", { origin: "top" });

// About section reveals (will adapt based on new CSS grid layout)
sr.reveal(".about__img", { origin: "left" });
sr.reveal(".about__content", { origin: "right" });


sr.reveal(
".skills__title, .skills__content, .qualification__name, .qualification__item, .service__card, .project__content, .testimonial__wrapper, .footer__content",
{
  delay: 500,
  interval: 100,
}
